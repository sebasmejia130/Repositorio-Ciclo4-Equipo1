...
public class Remision {
	...
	public Remision(Long id, String tipoExamen, String lugarProcedimiento, String fechaProcedimiento,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Remision other = (OrdenesRemisiones) obj;
	...
	public String toString() {
		return "Remision [id=" + id + ", tipoExamen=" + tipoExamen + ", lugarProcedimiento="
